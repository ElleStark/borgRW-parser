...
def main():
    ...
    # # Plot improvements for each run
    # sns.set()
    # fig, ax = plt.subplots()
    # sns.lineplot(
    #         data=metrics_df,
    ...
    # fig.show()
    #
    # # Plot hypervolumes for each run
    # sns.set()
    # fig, ax = plt.subplots()
    # sns.lineplot(
    #         data=metrics_df,
    ...
    # fig.show()
    #
    # # Plot ideal change for each run, relative to ideal of all runs combined
    # sns.set()
    # fig, ax = plt.subplots()
    # sns.lineplot(
    #         data=metrics_df,
    ...
    #         hue='Run'
    # )
    # plt.ylabel('Ideal_Change')
    # plt.xlabel('Function Evaluations')
    # fig.show()
    #
    # # Plot nadir change for each run, relative to ideal of all runs combined
    # sns.set()
    # fig, ax = plt.subplots()
    # sns.lineplot(
    #         data=metrics_df,
